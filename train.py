...
if __name__ == '__main__':
    ...
    parser.add_argument('--stage_len', type=int, default=8,
    ...
    parser.add_argument('--use_depth_for_coord', type=_strtobool, default=False,
    ...
    parser.add_argument('--depth_rank_weight', type=float, default=10.0,
                        help='weight for depth rank loss')
    parser.add_argument('--depth_quantile_weight', type=float, default=10.0,
                        help='weight for depth quantile loss')
    parser.add_argument('--depth_dist_weight', type=float, default=10.0,
                        help='weight for depth distribution loss')
    parser.add_argument('--depth_rank_pairs_per_image', type=int, default=64,
                        help='number of depth rank pairs per image')
    parser.add_argument('--min_samples_per_image', type=int, default=16,
    ...
    parser.add_argument('--depth_bucket_shuffle_each_epoch', type=_strtobool, default=True,
    ...
    parser.add_argument('--header', default=None, help='path of a starting checkpoint')
