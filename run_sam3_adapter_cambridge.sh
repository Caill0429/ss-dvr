...
# Settings
# =======================
K_SEM="${K_SEM:-7}"               # adaptive semantic labels cap -> proto_max
K_SPA_LIST=(1)      # rows
DATASETS=(                         # cols
...
DINO_DIR="$HOME/PycharmProjects/SAM3/sam3"
ACE_DIR="$HOME/PycharmProjects/ss-dvr/ss-dvr"

DINO_SCRIPT="sam3_pcs_semantic_label_generation.py"
...
RESULTS_FILE="$ACE_DIR/output/sam3_cambridge_grid_adaptSem$K_SEM.txt"
CELL_W=18
